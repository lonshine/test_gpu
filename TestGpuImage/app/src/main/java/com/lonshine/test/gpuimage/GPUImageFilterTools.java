        ...
        switch (type) {
            ...
            case TONE_CURVE:
                ...
                toneCurveFilter.setFromCurveFileInputStream(
                        context.getResources().openRawResource(R.raw.gpu_tone_cuver_sample));
            ...
            case LOOKUP_AMATORKA:
                ...
                amatorka.setBitmap(BitmapFactory.decodeResource(context.getResources(), R.drawable.gpu_lookup_amatorka));
                return amatorka;
            case GAUSSIAN_BLUR:
